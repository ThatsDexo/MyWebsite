            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/MyWebsite/" class="<?= urlIs(
                            "/MyWebsite/"
                        ) ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</a>
                        <a href="/MyWebsite/about" class="<?= urlIs(
                            "/MyWebsite/about"
                        ) ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</a>
                        <a href="/MyWebsite/notes" class="<?= urlIs(
                            "/MyWebsite/notes"
                        ) ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
                        <a href="/MyWebsite/contact" class="<?= urlIs(
                            "/MyWebsite/contact"
                        ) ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
